...
console.log("Memulai pembuatan slide presentasi EthicsKomdis (Tema Terang)...");
...
// Definisi palet warna Tema Terang (Light Theme)
const COLORS = {
  bg: "F8FAFC",       // Slate 50 (Sangat terang, latar belakang utama)
  card: "FFFFFF",     // White (Latar belakang kartu/box)
  accent: "4F46E5",   // Indigo 600 (Aksen utama / Biru-Ungu kontras)
  light: "0F172A",    // Slate 900 (Teks utama, gelap)
  muted: "475569",    // Slate 600 (Teks sekunder / abu-abu tua)
  crimson: "DC2626",  // Red 600 (Pelanggaran / Peringatan)
  emerald: "059669",  // Emerald 600 (Prestasi / Sukses)
  border: "CBD5E1"    // Slate 300 (Border untuk kartu)
};
...
const outputPath = path.join(__dirname, "..", "..", "docs", "EthicsKomdis_Presentasi_Terang.pptx");
